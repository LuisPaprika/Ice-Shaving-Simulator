...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pickup"",
                    ""type"": ""Button"",
                    ""id"": ""16a48d81-dfc2-4784-9439-25dc41e92121"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""26abaa79-d13d-4503-8c55-006ffac08242"",
        ...
        {
            ""name"": ""Shaving"",
            ""id"": ""4c7dce84-b6ce-449f-bb6f-c63eb79955f3"",
            ""actions"": [
                {
                    ""name"": ""Grab"",
                    ""type"": ""Button"",
                    ""id"": ""7a797b3d-1c8d-4be1-b6f2-338419f72996"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Exit"",
                    ""type"": ""Button"",
                    ""id"": ""ed11e7ae-685a-49fd-a8ed-90a2aef51aeb"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""69ff77a4-957e-45c8-9812-dcb85066e65b"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""710bf775-3ec4-4b52-880d-2e6108dd108f"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // Shaving
        m_Shaving = asset.FindActionMap("Shaving", throwIfNotFound: true);
        m_Shaving_Grab = m_Shaving.FindAction("Grab", throwIfNotFound: true);
        m_Shaving_Exit = m_Shaving.FindAction("Exit", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Shaving.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Shaving.Disable() has not been called.");
    }
    ...
    // Shaving
    private readonly InputActionMap m_Shaving;
    private List<IShavingActions> m_ShavingActionsCallbackInterfaces = new List<IShavingActions>();
    private readonly InputAction m_Shaving_Grab;
    private readonly InputAction m_Shaving_Exit;
    /// <summary>
    /// Provides access to input actions defined in input action map "Shaving".
    /// </summary>
    public struct ShavingActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ShavingActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Shaving/Grab".
        /// </summary>
        public InputAction @Grab => m_Wrapper.m_Shaving_Grab;
        /// <summary>
        /// Provides access to the underlying input action "Shaving/Exit".
        /// </summary>
        public InputAction @Exit => m_Wrapper.m_Shaving_Exit;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Shaving; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="ShavingActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(ShavingActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="ShavingActions" />
        public void AddCallbacks(IShavingActions instance)
        {
            if (instance == null || m_Wrapper.m_ShavingActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ShavingActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="ShavingActions" />
        private void UnregisterCallbacks(IShavingActions instance)
        {
            @Grab.started -= instance.OnGrab;
            @Grab.performed -= instance.OnGrab;
            @Grab.canceled -= instance.OnGrab;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ShavingActions.UnregisterCallbacks(IShavingActions)" />.
        /// </summary>
        /// <seealso cref="ShavingActions.UnregisterCallbacks(IShavingActions)" />
        public void RemoveCallbacks(IShavingActions instance)
        {
            if (m_Wrapper.m_ShavingActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="ShavingActions.AddCallbacks(IShavingActions)" />
        /// <seealso cref="ShavingActions.RemoveCallbacks(IShavingActions)" />
        /// <seealso cref="ShavingActions.UnregisterCallbacks(IShavingActions)" />
        public void SetCallbacks(IShavingActions instance)
        {
            foreach (var item in m_Wrapper.m_ShavingActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ShavingActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="ShavingActions" /> instance referencing this action map.
    /// </summary>
    public ShavingActions @Shaving => new ShavingActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Shaving" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="ShavingActions.AddCallbacks(IShavingActions)" />
    /// <seealso cref="ShavingActions.RemoveCallbacks(IShavingActions)" />
    public interface IShavingActions
    {
        /// <summary>
